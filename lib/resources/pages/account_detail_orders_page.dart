...
class AccountDetailOrdersPage extends NyStatefulWidget {
  static RouteView path = ("/account-orders", (_) => AccountDetailOrdersPage());

  AccountDetailOrdersPage() : super(child: () => _AccountDetailOrdersPageState());
}

class _AccountDetailOrdersPageState extends NyPage<AccountDetailOrdersPage> {
