...
class BookAClassPage extends NyStatefulWidget<BookAClassController> {
  static RouteView path = ("/book-a-class", (_) => BookAClassPage());

  BookAClassPage() : super(child: () => _BookAClassPageState());
}

class _BookAClassPageState extends NyPage<BookAClassPage> {
